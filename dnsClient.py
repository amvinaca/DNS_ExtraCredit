...
def dns_query(type, name, server):
    ...
    qname_encoded_parts = [struct.pack('B', len(part)) + part.encode('asciii') for part in qname_parts] # Make sure it's encoded as a sequence of the right character encoding type (lowercase)
